...
<body class="hold-transition skin-blue sidebar-mini">
	<div class="wrapper">
												...
												<div class="row">
													...
													<div class="col-lg-3">
														<div class="form-group">
															...
															<select class="form-control" name="identity_doc" id="identity_doc" required>
																...
																<option value="UMID" <?php echo $data['identity_doc']=='UMID'?'selected':''; ?>>UMID</option>
													...
													<div class="col-lg-3">
														<div class="form-group">
															...
															<input type="text" class="form-control" name="tin_no" id="tin_no" value="<?php echo $data['tin_no']; ?>" required />
														</div>
													</div>
													<div class="col-lg-3">
														<div class="form-group">
													...
													<div class="col-lg-3">
														<div class="form-group">
															...
															<input type="text" class="form-control" name="philhealth" id="philhealth" value="<?php echo $data['philhealth']; ?>" required />
														</div>
													</div>
													<div class="col-lg-3">
														<div class="form-group">
															<label for="SSS_no">SSS No.</label>
															<input type="text" class="form-control" name="sss_no" id="sss_no" value="<?php echo $data['sss_no']; ?>" required />
														</div>
													</div>
												</div>
												<div class="form-group">
		...
		<strong> &copy; <?php echo date("Y");?> Payroll Management System | </strong> Developed for Brgy. Tankulan MF. Bukidnon
		</footer>
	</div>
