						...
						<div class="modal-body">
							...
							<div class="form-group">
								<div class="row">
									...
									<div class="col-sm-4">
										<label for="ifsc_code">PhilHealth No.</label>
										<input type="text" class="form-control" name="philhealth" id="philhealth" required />
									</div>
								</div>
							</div>
							<div class="form-group">
								<div class="row">
									<div class="col-sm-4">
										<label for="pf_account">SSS No.</label>
										<input type="text" class="form-control" name="sss_no" id="sss_no" required />
									</div>
								</div>
							</div>
						</div>
