...
function GeneratePaySlip() {
    ...
    if ( !empty($emp_code) && !empty($pay_month) ) {
	    ...
	    $html .= '<img class="logo" src="' . BASE_URL . 'dist/img/logo.png" alt="Brgy . Tankulan MF. Buk" />';
	    $html .= '</div>';
	    $html .= '<div class="div_half">';
	    $html .= '<h2 class="com_title">Brgy . Tankulan MF. Buk</h2>';
	    ...
	    $html .= '<td>: ' . strtoupper($empData['philhealth']) . '</td>';
	    $html .= '</tr>';
	    ...
	    $html .= '<td>TIN</td>';
	    $html .= '<td>: ' . strtoupper($empData['tin_no']) . '</td>';
	    $html .= '</tr>';
	    ...
	    $html .= '<td>SSS No.</td>';
	    $html .= '<td>: ' . strtoupper($empData['sss_no']) . '</td>';
	    $html .= '</tr>';
			...
			$html .= '<table class="emp_info">';
				$html .= '<thead>';
					$html .= '<tr>';
						...
						$html .= '<th width="200">';
							$html .= '<img width="100" src="' . BASE_URL . '" alt="" /><br />';
							$html .= '<strong></strong>';
						$html .= '</th>';
					$html .= '</tr>';
				$html .= '</thead>';
...
function SendPaySlipByMail() {
	...
	if ( $empData ) {
		...
		$message .= '<hr/>';
		$message .= '<p>Thank You,<br/>Brgy . Tankulan MF. Buk</p>';
