...
define('BASE_URL', 	   'http://localhost/brgy-tankulan-payroll-ms/');
define('REG_URL', 	   'http://localhost/brgy-tankulan-payroll-ms/registration/');
define('COMPANY_NAME', 'Brgy.Tankulan-Payroll Management System');
